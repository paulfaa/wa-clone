...
describe('MessageParsingService', () => {
  ...
  `
    ...
    afterEach(() => {
        messageServiceSpy.addMessages.calls.reset()
    })
    ...
    describe('getAllChatMembers()', () => {
        it('Returns a list of all members in the chat', () => {
            //Arrange
            const names = ['Person1', 'Person2', 'Person1']
    ...
    describe('parseJson()', () => {
        it('throws an error if the json is invalid', () => {
            ...
            //Assert
            expect(() =>
                service.parseJsonString(invalidJsonString)
      ...
      "chats": [
          {
            ...
            //Assert
            expect(messageServiceSpy.addMessages).toHaveBeenCalledWith(
                expectedArg
            )
