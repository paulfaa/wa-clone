...
export const sampleMessage1: WhatsappMessage = {
    ...
    timestamp: new Date("2019-10-05T00:00:00Z"),
    fromMe: true,
...
export const sampleMessage2: WhatsappMessage = {
    ...
    timestamp: new Date("2020-03-12T00:00:00Z"),
    fromMe: true,
    type: MessageType.text,
    text: "Lorum Ipsum"
}
...
export const sampleMessage3: WhatsappMessage = {
    ...
    timestamp: new Date("2020-10-13T00:00:00Z"),
    fromMe: true,
    type: MessageType.text,
    text: "Hello world..."
}
...
export const sampleMessage4: WhatsappMessage = {
    ...
    timestamp: new Date("2020-05-14T00:00:00Z"),
    fromMe: true,
    type: MessageType.text,
